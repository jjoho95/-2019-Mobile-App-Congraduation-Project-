...
public class InternActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_int);
    ...
    public void onClickListener(View view) {
        ...
        switch (id) {
            case R.id.buttonAddItem:
                AlertDialog.Builder builder = new AlertDialog.Builder(InternActivity.this);
                View v = LayoutInflater.from(InternActivity.this).inflate(R.layout.layout_editbox, null, false);
                builder.setView(v);
...
//    }
    ...
    public void oneditADDbtnclicked(View view) {
