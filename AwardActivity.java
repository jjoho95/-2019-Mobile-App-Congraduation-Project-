...
public class AwardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new AwardActivity.RecyclerTouchListener(getApplicationContext(), recyclerView, new AwardActivity.ClickListener() {
...
*/
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private AwardActivity.ClickListener clickListener;

        public RecyclerTouchListener(Context applicationContext, final RecyclerView recyclerView, final AwardActivity.ClickListener clickListener) {
