...
public class IntActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MyAdapter(mArrayList);
    ...
    public void onClickListener(View view) {
        ...
        switch (id) {
            case R.id.buttonAddItem:
                AlertDialog.Builder builder = new AlertDialog.Builder(IntActivity.this);
                View v = LayoutInflater.from(IntActivity.this).inflate(R.layout.layout_editbox, null, false);
                builder.setView(v);
...
*/
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private IntActivity.ClickListener clickListener;
